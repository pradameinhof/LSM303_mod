...
{
  //pradameinhof mod: commenting out vector selection based on board auto-detection and hardcoding vector
  //if (_device == device_D)
  //{
  ...
  //}
  //pradameinhof mod: Hardcoding vector (X,Y,Z) - only choose one XYZ direction to indicate where you'd like to detect north
  return heading((vector<int>){1, 0, 0});
}
